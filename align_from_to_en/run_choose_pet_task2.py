...
if __name__=='__main__':
    ...
    ##
    # train data
    ind_image_train, ind_text_train = load_file_from_task(task_idx=2,n_obs=None,split='train', image_preprocessor=preprocess)
    _, from_text_train = load_file_from_task(task_idx=2,n_obs=None,split='train_trans_from_en', image_preprocessor=preprocess)
    _, to_text_train = load_file_from_task(task_idx=2,n_obs=None,split='train_trans_to_en', image_preprocessor=preprocess)

    # val data
    ind_image_val, ind_text_val = load_file_from_task(task_idx=2,n_obs=None,split='val', image_preprocessor=preprocess)
    _, from_text_val = load_file_from_task(task_idx=2,n_obs=None,split='val_trans_from_en', image_preprocessor=preprocess)
    _, to_text_val = load_file_from_task(task_idx=2,n_obs=None,split='val_trans_to_en', image_preprocessor=preprocess)

    # test data
    ind_image_test, ind_text_test = load_file_from_task(task_idx=2,n_obs=None,split='test_2016_flickr', image_preprocessor=preprocess)
    _, from_text_test = load_file_from_task(task_idx=2,n_obs=None,split='test_2016_flickr_trans_from_en', image_preprocessor=preprocess)
    _, to_text_test = load_file_from_task(task_idx=2,n_obs=None,split='test_2016_flickr_trans_to_en', image_preprocessor=preprocess)
