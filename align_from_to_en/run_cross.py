...
def prepare(args):
    ...
    args.output_dir = os.path.join(args.output_basedir,f"{args.language}_{args.delta_tuning}_{args.n_shot}_t{args.text_lr}_r{args.text_loss_ratio}_{args.strategy}_{args.text_loss_strategy}_{times}")
...
if __name__=='__main__':
    ...
    if args.delta_tuning:
        ...
        text_delta_model = AutoDeltaModel.from_config(config, text_model)
    ...
    if args.strategy=='method1' or args.strategy=='baseline1':
    ...
    elif args.strategy=='method2' or args.strategy=='baseline2' or args.strategy=='method3':
